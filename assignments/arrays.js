...
console.log('Make and model of the last car in the inventory: ' + inventory[49].car_make + ' ' + inventory[49].car_model);
...
console.log('Alphabetical list of car models: ' + carModels.sort());
...
console.log('Car Years in inventory: ' + carYears);
...
console.log('Number of cars older than the year 2000: ' + oldCars.length); 
...
console.log('Available BMWs and Audis: ' + JSON.stringify(BMWAndAudi));
