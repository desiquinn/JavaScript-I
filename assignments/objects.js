...
kennan.says = function() {
  const name = 'Hello, my name is ' + this.name + '!';
  return name;
};

console.log(kennan.says());
...
parent.child.saysName = function() {
  return "Hi my name is " + this.name + "!"
};
...
parent.child.grandchild.saysName = function() {
  return "Hi my name is " + this.name + "!"
};
